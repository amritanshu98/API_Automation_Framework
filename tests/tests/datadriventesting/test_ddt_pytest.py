...
@pytest.mark.parametrize("user_cred", read_credentials_from_excel(r"D:\Automation_via_Python\API_Automation_Framework\tests\tests\datadriventesting\data_driven_testing.xlsx"))
